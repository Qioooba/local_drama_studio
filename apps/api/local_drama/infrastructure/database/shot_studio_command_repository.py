...
class SqliteShotStudioCommandRepository:
    ...
    def adopt_working_version(self, media_version_id: str, *, actor: str) -> dict[str, Any]:
        ...
        # Adopting a video does not authorize a continuity bridge. A real
        # LAST_FRAME extraction plus an existing explicit transition is
        # required before FrameChainingService may inherit anything.
