...
def production_execution_handlers() -> ExecutionHandlerRegistry:
    ...
    return ExecutionHandlerRegistry([
        ...
        *(ExecutionHandlerDescriptor(ollama_code, ollama_version, capability, frozenset({"ollama.chat.v1"}), "GPU_H3", "OLLAMA") for capability in sorted({"LLM_STORY_PARSE", "LLM_EPISODE_PLAN", "LLM_STORYBOARD", "LLM_PROMPT_REWRITE"})),
