...
export function GlobalSearchPanel({ projectId }: { projectId?: string | null }) {
  ...
  return <section className="panel global-search-panel" aria-labelledby="global-search-title">
    <div className="panel-heading"><div><p className="eyebrow">FR-SRC-001 · 全局搜索</p><h3 id="global-search-title">全局搜索</h3></div><span className="status-pill neutral">{projectId ? "当前项目" : "所有项目"}</span></div>
