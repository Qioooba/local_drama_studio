...
export function ReviewInboxPanel({
  ...
  useEffect(() => { setChecks({}); setDecision("APPROVED"); setReviewComment(""); setCompareVersionId(null); setPlaybackRate(1); setLoopPreview(false); setMutedPreview(false); }, [selectedVersionId]);
