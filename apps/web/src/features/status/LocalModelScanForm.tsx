...
export function LocalModelScanForm() {
  ...
  return <div className="model-license-import local-model-scan-form">
    <div className="workflow-history-heading"><div><p className="eyebrow">FR-OPS-002 · OFFLINE SCAN</p><h3>扫描电脑里的模型目录</h3></div><span className="status-pill neutral">只读 · 不复制权重</span></div>
