...
type SeasonTarget = { id: string; code: string; title: string; episodes: Array<{ target_duration_ms?: number }> };

export function ProjectStructureAppendPanel({ projectId, seasons, projectDefaultDurationMs }: { projectId: string; seasons: SeasonTarget[]; projectDefaultDurationMs?: number }) {
