...
export function StoryboardBatchWorkbench({ projectId, episodeId }: { projectId?: string; episodeId: string }) {
  ...
  const [splitDialogueDestination, setSplitDialogueDestination] = useState<"FIRST" | "SECOND" | "SOURCE_ONLY">("SOURCE_ONLY");
  const [splitActionDestination, setSplitActionDestination] = useState<"FIRST" | "SECOND" | "BOTH" | "SOURCE_ONLY">("BOTH");
