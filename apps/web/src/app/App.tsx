...
import { StoryAssetLibraryPanel } from "../features/production/StoryAssetLibraryPanel";
          ...
          {view === "projects" && (
            <section className="panel">
              ...
              {selectedProject && <div className="production-summary">
                ...
                {selectedProject && <StoryAssetLibraryPanel projectId={selectedProject} />}
                ...
                {selectedEpisode && <SubtitleRevisionPanel episodeId={selectedEpisode} projectId={selectedProject ?? ""} defaultSourceDocumentVersionId={String(timelineStatus.data?.status.subtitles.latest?.source_document_version_id ?? "")} onCreated={() => { void timelineStatus.refetch(); void g8Readiness.refetch(); }} />}
