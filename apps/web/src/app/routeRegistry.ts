...
export const ROUTE_REGISTRY: Record<string, RouteMetadata> = {
  ...
  episodePlan: { id: "episodePlan", scope: "EPISODE", title: "策划", pathPattern: "/projects/:projectId/episodes/:episodeId/plan", parentRouteId: "projectHome" },
  ...
  episodeProduction: { id: "episodeProduction", scope: "EPISODE", title: "生产", pathPattern: "/projects/:projectId/episodes/:episodeId/production", parentRouteId: "episodePlan" },
