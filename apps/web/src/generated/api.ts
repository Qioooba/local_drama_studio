...
export type ProfileVersionDetail = { id: string; execution_profile_id: string; code: string; title: string; version_no: number; capability: string; status: string; revision: number; input_contract: Record<string, unknown>; parameter_schema: Record<string, unknown>; output_contract: Record<string, unknown>; resource_policy: Record<string, unknown>; contract_hash: string; validation: null | { id: string; status: string; contract_hash: string; checks: Array<{ code: string; passed: boolean; label?: string }> } };
...
export async function validateProfileContractVersion(profileVersionId: string, baseUrl = ''): Promise<{ validation: { id: string; profile_version_id: string; contract_hash: string; status: 'PASS' | 'FAIL'; checks: Array<{ code: string; passed: boolean; label?: string }>; runtime_contacted: false; network_contacted: false } }> {
