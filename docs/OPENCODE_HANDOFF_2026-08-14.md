...
- G10 继续推进：离线 SBOM 生成器 `scripts/generate_sbom.py` 已从两个锁文件和本地元数据生成 317 个包条目；只读审计新增 `SBOM_INVENTORY=PASS`，但因 304 项许可证为 `NOASSERTION` 及前置 G7/G8/G9 未完成，发布工件仍保持 DRAFT/NO-GO。
