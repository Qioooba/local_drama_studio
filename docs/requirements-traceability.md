...
| G8 formal screenshots/sample/UAT and G8→G9 exit approval | IN_PROGRESS | Continue evidence capture and later gate audit |
...
| 三视图 route/selection 同步、automation/webhook/产能看板 | IN_PROGRESS | P1 后续 G9 工作项，不影响当前 P0 画布基础代码完成 |
...
| G7 regression | PASS (current scope) | 安全 API 102 passed / 4 live deselected；Web 9/9、production build、Ruff、mypy 81 source files；三档 Playwright 全绿且视觉只读 720px WebP |
