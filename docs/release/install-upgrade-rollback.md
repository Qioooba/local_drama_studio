...
4. 验证 migration head=`0032_episode_render_execution_evidence`、G7/G8/G9 readiness、API/Web 回归和 LOCAL_ONLY 连接状态。
...
升级到 `0032_episode_render_execution_evidence`，同时验证独立恢复副本与源备份 SHA-256
完全一致；证据见 `docs/evidence/g10/upgrade-rollback-rehearsal-0032-2026-08-15.json`。
