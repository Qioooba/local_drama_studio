...
4. 验证 migration head=`0038_outbox_delivery_ledger`、G7/G8/G9 readiness、API/Web 回归和 LOCAL_ONLY 连接状态。
...
升级到 `0038_outbox_delivery_ledger`，同时验证独立恢复副本与源备份 SHA-256
完全一致；证据见 `docs/evidence/g10/upgrade-rollback-rehearsal-0038-2026-08-16.json`。
