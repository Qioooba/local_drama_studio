...
4. 验证 migration head=`0033_brand_watermark_compliance_versions`、G7/G8/G9 readiness、API/Web 回归和 LOCAL_ONLY 连接状态。
...
升级到 `0033_brand_watermark_compliance_versions`，同时验证独立恢复副本与源备份 SHA-256
完全一致；证据见 `docs/evidence/g10/upgrade-rollback-rehearsal-0033-2026-08-15.json`。
