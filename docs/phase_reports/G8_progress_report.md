...
- 1024×768 浏览器验收：真实页面显示“暂无真实 revision/render/delivery”，零 console/page error、零失败响应、零水平溢出；视觉证据仅为 720px WebP `docs/evidence/g8/timeline-status-visual-review-2026-08-14.json`。
