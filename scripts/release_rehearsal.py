...
HEAD_MIGRATION = "0034_local_automation_webhooks"
...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, default=ROOT / "docs" / "evidence" / "g10" / "upgrade-rollback-rehearsal-0034-2026-08-15.json")
