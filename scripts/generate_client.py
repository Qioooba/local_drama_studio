...
export type EpisodeOperationImpact = { schema_version: 'episode-operation-impact/v1'; episode_id: string; project_id: string; operation: EpisodeProductionOperation; target_shot_ids: string[]; target_take_count: number; sets: Record<string, Array<Record<string, unknown>>>; gpu_video_job_count: number; mutated: false; runtime_contacted: false; network_contacted: false; plan_hash: string };
...
export async function previewEpisodeProductionOperationV2(episodeId: string, payload: { operation: EpisodeProductionOperation; target_shot_ids?: string[]; target_take_count?: number }, baseUrl = ''): Promise<{ impact: EpisodeOperationImpact }> {
